...
use Symfony\Component\HttpFoundation\{JsonResponse, Request, Resquest, Response};
...
class RestaurantController extends AbstractController
{
    public function __construct(
        ...
        private UrlGeneratorInterface $urlGerenerator,
        )
    {
    }
    ...
    public function new(Request $request): JsonResponse
    {
        ...
        $location = $this->urlGerenerator->generate(
            '/{id}',
            ['id' => $restaurant->getId()],
